...
ent-DefaultStationBeaconHOPOffice = { ent-DefaultStationBeaconCommand }
    .suffix = Escritório do médico de família
    .desc = { ent-DefaultStationBeaconCommand.desc }
