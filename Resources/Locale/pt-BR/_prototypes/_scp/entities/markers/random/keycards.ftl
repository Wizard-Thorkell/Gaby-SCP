ent-RandomJuniorKeycardSpawnerBase = gerador de cartão-chave para funcionários juniores
    .desc = Gera o cartão-chave de um funcionário júnior. Não inclui segurança.
...
ent-RandomStaffKeycardSpawnerBase = gerador de cartão-chave de funcionário
    .desc = Gera um cartão-chave de funcionário ou estagiário. Não inclui segurança.
...
ent-RandomTechnicalKeycardSpawnerBase = Gerador de cartão-chave para engenharia e serviço técnico
    .desc = Gera o cartão-chave de um funcionário de engenharia e serviço técnico. Não inclui anciãos ou chefes.
...
ent-RandomServiceKeycardSpawnerBase = gerador de cartão-chave de serviço
    .desc = Gera o cartão-chave de um funcionário do atendimento ao cliente.
