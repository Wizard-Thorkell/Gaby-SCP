...
alert-desc-scp096-face-idle = { alert-desc-scp096-face-base }
    Há um universo inteiro de tormento neste silêncio. Eles respiram, eles riem... e eu fervo num grito contido. Alguma hora terei oportunidade de sair deste desespero.

alert-desc-scp096-face-rage = { alert-desc-scp096-face-base }
    EU SOU A ENTROPIA EXPLOSIVA DO UNIVERSO!
    ​[color=red] DEIXE SUAS ALMAS PARA O FOGO ETERNO DO MEU ÓDIO![/color]

alert-desc-scp096-face-heating-up = { alert-desc-scp096-face-base }
    > ROSTOS QUEIMAM EM MINHA MEMÓRIA <
    Seus traços estão gravados em minha pele! Cada olhar deles é um prego no caixão da minha paz! [color=red]VOU APAGA-LOS DEBAIXO DA MINHA PRÓPRIA PELE![/color]
