...
id-card-access-level-head-of-personnel = Chefe de Gabinete
...
id-card-access-level-security = Serviço de segurança
...
id-card-access-level-cargo = Fornecer
id-card-access-level-salvage = Reciclagem
...
id-card-access-level-janitor = Limpador
