...
comp-gas-tank-examine-open-valve = A válvula de liberação de gás está [color=red]open[/color].
comp-gas-tank-examine-closed-valve = A válvula de liberação de gás está [color=green]fechada[/color].

## ControlVerb
control-verb-open-control-panel-text = Abra o Painel de Controle
...
## Valve
comp-gas-tank-open-valve = Válvula aberta
