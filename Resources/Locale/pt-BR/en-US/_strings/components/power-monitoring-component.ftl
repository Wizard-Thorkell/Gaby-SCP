...
power-monitoring-window-label-smes = PME
...
power-monitoring-window-flavor-left = [user@nanotrasen] $executar power_net_query
power-monitoring-window-flavor-right = v1.3
power-monitoring-window-rogue-power-consumer = [color=white][font size=14][bold]! AVISO - DISPOSITIVO CONSUMIDOR DE ENERGIA ROGUE DETECTADO![/bold][/font][/color]
