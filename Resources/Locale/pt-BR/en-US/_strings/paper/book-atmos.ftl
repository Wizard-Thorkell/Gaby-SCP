book-text-atmos-distro = A rede de distribuição, ou “distro”, abreviadamente, é a tábua de salvação da estação. É responsável por transportar o ar atmosférico por toda a estação.
...
book-text-atmos-waste = A rede de resíduos é o principal sistema responsável por manter o ar da estação livre de contaminantes.
...
book-text-atmos-alarms = Os alarmes aéreos estão localizados nas estações para permitir o gerenciamento e monitoramento da atmosfera local.
